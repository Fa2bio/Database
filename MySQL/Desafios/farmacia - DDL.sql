...
CREATE TABLE IF NOT EXISTS `farmacia`.`vendas` (
  ...
  `data` DATE NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_vendas_1_idx` (`id_cliente` ASC),
...
-- -----------------------------------------------------
-- Table `farmacia`.`produtos_venda`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `farmacia`.`produtos_venda` ;

CREATE TABLE IF NOT EXISTS `farmacia`.`produtos_venda` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `id_produto` INT NOT NULL,
  `id_venda` INT NOT NULL,
  `quantidade` INT NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_produtos_compra_1_idx` (`id_venda` ASC) ,
  INDEX `fk_produtos_compra_2_idx` (`id_produto` ASC) ,
  CONSTRAINT `fk_produtos_compra_1`
    FOREIGN KEY (`id_venda`)
    REFERENCES `farmacia`.`vendas` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
